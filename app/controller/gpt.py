...
def generate_llm_output(equipment_name):
    ...
    template = '''
            ...
            Please focus on main muscle area for equipment when talking about target muscle.
    ...
    answer = chain.invoke({"example":example, "equipment":equipment})
